...
export class InitialMigration1692627056313 implements MigrationInterface {
    name = 'InitialMigration1692627056313'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pessoa_imoveis_registro_imovel" ("pessoaId" integer NOT NULL, "registroImovelId" integer NOT NULL, CONSTRAINT "PK_e2f9d1445a73aa94fa3323483d1" PRIMARY KEY ("pessoaId", "registroImovelId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5451204e8b1209cd82f1e6091a" ON "pessoa_imoveis_registro_imovel" ("pessoaId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8227a749a8f1dfa18070bede29" ON "pessoa_imoveis_registro_imovel" ("registroImovelId") `);
        ...
        await queryRunner.query(`ALTER TABLE "pessoa_imoveis_registro_imovel" ADD CONSTRAINT "FK_5451204e8b1209cd82f1e6091af" FOREIGN KEY ("pessoaId") REFERENCES "pessoa"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pessoa_imoveis_registro_imovel" ADD CONSTRAINT "FK_8227a749a8f1dfa18070bede291" FOREIGN KEY ("registroImovelId") REFERENCES "registro_imovel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pessoa_imoveis_registro_imovel" DROP CONSTRAINT "FK_8227a749a8f1dfa18070bede291"`);
        await queryRunner.query(`ALTER TABLE "pessoa_imoveis_registro_imovel" DROP CONSTRAINT "FK_5451204e8b1209cd82f1e6091af"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8227a749a8f1dfa18070bede29"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5451204e8b1209cd82f1e6091a"`);
        await queryRunner.query(`DROP TABLE "pessoa_imoveis_registro_imovel"`);
