...
export class InitialMigration1692470351444 implements MigrationInterface {
    name = 'InitialMigration1692470351444'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tabela_pessoas_fisicas_orm" ("id" SERIAL NOT NULL, "tipo" character varying NOT NULL, "funcao" text NOT NULL, "formaPagamento" text NOT NULL, "nome" character varying NOT NULL, "cpf" character varying NOT NULL, "identidade" character varying NOT NULL, "orgao_expedidor" character varying NOT NULL, "data_nascimento" TIMESTAMP NOT NULL, "profissao" character varying NOT NULL, "estado_civil" character varying NOT NULL, "endereco" character varying NOT NULL, "genero" character varying NOT NULL, "pdf" character varying, CONSTRAINT "PK_92e344b710970f18dbdf34fa1e2" PRIMARY KEY ("id"))`);
