...
exports.InitialMigration1692900095929 = void 0;
class InitialMigration1692900095929 {
    constructor() {
        this.name = 'InitialMigration1692900095929';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'user', CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
...
exports.InitialMigration1692900095929 = InitialMigration1692900095929;
