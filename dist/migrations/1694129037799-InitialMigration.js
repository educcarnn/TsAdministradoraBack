...
exports.InitialMigration1694129037799 = void 0;
class InitialMigration1694129037799 {
    constructor() {
        this.name = 'InitialMigration1694129037799';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TYPE "public"."pessoa_role_enum" AS ENUM('admin', 'user')`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TYPE "public"."pessoa_role_enum"`);
            yield queryRunner.query(`DROP TABLE "registro_imovel"`);
        });
    }
}
exports.InitialMigration1694129037799 = InitialMigration1694129037799;
